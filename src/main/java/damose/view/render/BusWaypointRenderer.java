...
/**
 * Rendering logic for bus waypoint renderer.
 */
public class BusWaypointRenderer implements WaypointRenderer<BusWaypoint> {
    ...
    static {
        FALLBACK_COLORS.put(VehicleType.BUS, new Color(76, 175, 80));
        FALLBACK_COLORS.put(VehicleType.TRAM, new Color(255, 152, 0));
        FALLBACK_COLORS.put(VehicleType.METRO, new Color(63, 81, 181));
        FALLBACK_COLORS.put(VehicleType.RAIL, new Color(139, 69, 19));
        FALLBACK_COLORS.put(VehicleType.FERRY, new Color(0, 188, 212));
        FALLBACK_COLORS.put(VehicleType.UNKNOWN, new Color(158, 158, 158));
    }
